    ...
    <div class="swiper main-swiper py-4" data-aos="fade-up" data-aos-delay="600">
        ...
        <div class="swiper-slide">
            ...
            <div class="image-holder">
                <a href="#">
                <img src="default/images/banner-image-6.jpg" alt="product" class="img-fluid">
                </a>
            </div>
        ...
        <div class="swiper-slide">
            ...
            <div class="image-holder">
                <a href="#">
                <img src="default/images/banner-image-1.jpg" alt="product" class="img-fluid">
                </a>
            </div>
            <div class="banner-content py-4">
                <h5 class="element-title text-uppercase">
        ...
        <div class="swiper-slide">
            ...
            <div class="image-holder">
                <a href="#">
                <img src="default/images/banner-image-2.jpg" alt="product" class="img-fluid">
                </a>
            </div>
            <div class="banner-content py-4">
                <h5 class="element-title text-uppercase">
        ...
        <div class="swiper-slide">
            ...
            <div class="image-holder">
                <a href="#">
                <img src="default/images/banner-image-3.jpg" alt="product" class="img-fluid">
                </a>
            </div>
            <div class="banner-content py-4">
                <h5 class="element-title text-uppercase">
        ...
        <div class="swiper-slide">
            ...
            <div class="image-holder">
                <a href="#">
                <img src="default/images/banner-image-4.jpg" alt="product" class="img-fluid">
                </a>
            </div>
            <div class="banner-content py-4">
                <h5 class="element-title text-uppercase">
        ...
        <div class="swiper-slide">
            ...
            <div class="image-holder">
                <a href="#">
                <img src="default/images/banner-image-5.jpg" alt="product" class="img-fluid">
                </a>
            </div>
            <div class="banner-content py-4">
                <h5 class="element-title text-uppercase">
    ...
    <div class="row">
        ...
        <div class="cat-item image-zoom-effect">
            ...
            <a href="shop-four-column-wide.html">
                <img src="default/images/cat-item1.jpg" alt="categories" class="product-image img-fluid">
            </a>
            </div>
        ...
        <div class="cat-item image-zoom-effect">
            <div class="image-holder">
            <a href="shop-four-column-wide.html">
                <img src="default/images/cat-item2.jpg" alt="categories" class="product-image img-fluid">
            </a>
            </div>
            <div class="category-content">
            <div class="product-button">
        ...
        <div class="cat-item image-zoom-effect">
            <div class="image-holder">
            <a href="shop-four-column-wide.html">
                <img src="default/images/cat-item3.jpg" alt="categories" class="product-image img-fluid">
            </a>
            </div>
            <div class="category-content">
            <div class="product-button">
    ...
    <div class="swiper-wrapper d-flex">
        ...
        <div class="product-item image-zoom-effect link-effect">
            ...
            <a href="single-product.html">
                <img src="default/images/product-item-1.jpg" alt="categories" class="product-image img-fluid">
            </a>
        ...
        <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder position-relative">
            <a href="single-product.html">
                <img src="default/images/product-item-2.jpg" alt="categories" class="product-image img-fluid">
            </a>
            <a href="wishlist.html" class="btn-icon btn-wishlist">
                <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="#heart"></use>
        ...
        <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder position-relative">
            <a href="single-product.html">
                <img src="default/images/product-item-3.jpg" alt="categories" class="product-image img-fluid">
            </a>
            <a href="wishlist.html" class="btn-icon btn-wishlist">
                <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="#heart"></use>
        ...
        <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder position-relative">
            <a href="single-product.html">
                <img src="default/images/product-item-4.jpg" alt="categories" class="product-image img-fluid">
            </a>
            <a href="wishlist.html" class="btn-icon btn-wishlist">
                <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="#heart"></use>
        ...
        <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder position-relative">
            <a href="single-product.html">
                <img src="default/images/product-item-10.jpg" alt="categories" class="product-image img-fluid">
            </a>
            <a href="wishlist.html" class="btn-icon btn-wishlist">
                <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="#heart"></use>
...
<div class="container">
    ...
    <div class="collection-item d-flex flex-wrap my-5">
        ...
        <div class="image-holder">
            <img src="default/images/single-image-2.jpg" alt="collection" class="product-image img-fluid">
        </div>
        </div>
...
<div class="container">
    ...
    <div class="swiper-wrapper d-flex">
        ...
        <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder">
            <a href="single-product.html">
                <img src="default/images/product-item-3.jpg" alt="product" class="product-image img-fluid">
            </a>
            <a href="wishlist.html" class="btn-icon btn-wishlist">
                <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="#heart"></use>
        ...
        <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder">
            <a href="single-product.html">
                <img src="default/images/product-item-5.jpg" alt="categories" class="product-image img-fluid">
            </a>
            <a href="wishlist.html" class="btn-icon btn-wishlist">
                <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="#heart"></use>
        ...
        <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder">
            <a href="single-product.html">
                <img src="default/images/product-item-6.jpg" alt="categories" class="product-image img-fluid">
            </a>
            <a href="wishlist.html" class="btn-icon btn-wishlist">
                <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="#heart"></use>
        ...
        <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder">
            <a href="single-product.html">
                <img src="default/images/product-item-9.jpg" alt="categories" class="product-image img-fluid">
            </a>
            <a href="wishlist.html" class="btn-icon btn-wishlist">
                <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="#heart"></use>
...
<div class="container-fluid">
    ...
    <div class="video-content open-up" data-aos="zoom-out">
        <div class="video-bg">
        <img src="default/images/video-image.jpg" alt="video" class="video-image img-fluid">
        </div>
        ...
        <a class="youtube" href="https://www.youtube.com/embed/pjtsGzQjFM4">
            ...
            <img src="default/images/text-pattern.png" alt="pattern" class="text-rotate">
        </a>
        </div>
    </div>
    </div>
...
<div class="container">
    ...
    <div class="swiper-wrapper d-flex">
        ...
        <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder">
            <a href="single-product.html">
                <img src="default/images/product-item-5.jpg" alt="product" class="product-image img-fluid">
            </a>
            <a href="wishlist.html" class="btn-icon btn-wishlist">
                <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="#heart"></use>
        ...
        <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder">
            <a href="single-product.html">
                <img src="default/images/product-item-6.jpg" alt="product" class="product-image img-fluid">
            </a>
            <a href="wishlist.html" class="btn-icon btn-wishlist">
                <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="#heart"></use>
        ...
        <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder">
            <a href="single-product.html">
                <img src="default/images/product-item-7.jpg" alt="product" class="product-image img-fluid">
            </a>
            <a href="wishlist.html" class="btn-icon btn-wishlist">
                <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="#heart"></use>
        ...
        <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder">
            <a href="single-product.html">
                <img src="default/images/product-item-8.jpg" alt="product" class="product-image img-fluid">
            </a>
            <a href="wishlist.html" class="btn-icon btn-wishlist">
                <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="#heart"></use>
        ...
        <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder">
            <a href="single-product.html">
                <img src="default/images/product-item-1.jpg" alt="product" class="product-image img-fluid">
            </a>
            <a href="wishlist.html" class="btn-icon btn-wishlist">
                <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="#heart"></use>
...
<div class="container">
    ...
    <div class="col-md-4">
        ...
        <div class="post-image">
            ...
            <img src="default/images/post-image1.jpg" alt="image" class="post-grid-image img-fluid">
            </a>
        </div>
    ...
    <div class="col-md-4">
        ...
        <div class="post-image">
            <a href="single-post.html">
            <img src="default/images/post-image2.jpg" alt="image" class="post-grid-image img-fluid">
            </a>
        </div>
        <div class="post-content d-flex flex-wrap gap-2 my-3">
            <div class="post-meta text-uppercase fs-6 text-secondary">
    ...
    <div class="col-md-4">
        ...
        <div class="post-image">
            <a href="single-post.html">
            <img src="default/images/post-image3.jpg" alt="image" class="post-grid-image img-fluid">
            </a>
        </div>
        <div class="post-content d-flex flex-wrap gap-2 my-3">
            <div class="post-meta text-uppercase fs-6 text-secondary">
...
<div class="container">
    ...
    <div class="logo-content d-flex flex-wrap justify-content-between">
        <img src="default/images/logo1.png" alt="logo" class="logo-image img-fluid">
        <img src="default/images/logo2.png" alt="logo" class="logo-image img-fluid">
        <img src="default/images/logo3.png" alt="logo" class="logo-image img-fluid">
        <img src="default/images/logo4.png" alt="logo" class="logo-image img-fluid">
        <img src="default/images/logo5.png" alt="logo" class="logo-image img-fluid">
    </div>
    </div>
</div>
</section>